...
namespace PROLINSA_SISTEMA.Controllers
{
    ...
    public class CargosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDCargo,Cargo,Descripcion")] Cargos cargos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDCargo,Cargo,Descripcion")] Cargos cargos)
        {
            if (ModelState.IsValid)
            {
